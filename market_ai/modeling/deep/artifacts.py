...
def write_deep_metadata(
    ...
    *,
    ...
    raw = {
        ...
        "n_train": metadata.get("n_train") or (metadata.get("metrics") or {}).get("n_train"),
        "n_val": metadata.get("n_val") or (metadata.get("metrics") or {}).get("n_val"),
        "n_test": metadata.get("n_test") or (metadata.get("metrics") or {}).get("n_test"),
        "data_source": metadata.get("data_source") or (metadata.get("data_report") or {}).get("source"),
        "synthetic_used": metadata.get("synthetic_used"),
